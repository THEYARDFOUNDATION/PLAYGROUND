...
contract BasicPlaygroundToken is Context, IERC20, Ownable {
    ...
    uint256 private _fee1 = 10; // 1%, change name of this variable for your use case
    uint256 private _fee2 = 10; // 1%, change name of this variable for your use case

    uint256 public _totalFee = _fee1 + _fee2;

    address private _fee1Wallet = address(0); // change name and value of this variable for your use case
    address private _fee2Wallet = address(0); // change name and value of this variable for your use case;
